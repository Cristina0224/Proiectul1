    ...
    <iframe width="420" height="315" src="multimedia/bon.mp3"></iframe>
                            ...
                            <div>
                             ...
                             <?php 
                                   ...
                                   <a class="btn btn-primary btn-outline" href="upload_images.php">Upload another image</a> <?php }}?>
 ...
 <?php
       while($row=mysqli_fetch_array($query)){
           ...
           ?>    <div>      <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">      
						...
						<div><img style="max-height:250px;max-width: 250px;"src="<?php echo $row['image']; ?>">
                                                <h3 ><?php echo $row['title'];?></h3>  
						<h2 style="margin-top:10px;"class="fh5co-price"><?php echo $row['pret'];?></h2>
                                                <h2><?php echo $row['descriere'];?></h2></div>
                                                   
       
                                               <div class="btn btn-primary btn-outline">
  <?php echo "<a href=\"delete_image.php?id=".$row['id']."\" onclick=\"return confirm('Are you sure you want to delete this image?');\">Delete</a>"; ?>
</div>

                                                  <div class="btn btn-primary btn-outline"><?php echo "<a href=\"edit_image.php?id=".$row['id']."\">Edit</a>" ?></div> </div> 
               </div></div>
