...
<html>
	...
	<body>
	<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/ro_RO/sdk.js#xfbml=1&version=v16.0" nonce="RtCImdH2"></script>	
...
<div class="row form-group">
		<div class="col-md-6">
                            <form name="login" method="post" action="login.php">
                                Username: <input class="form-control" id="name"type="text" name="username"><br> 
                                Password: <input class="form-control" id="name" type="password" name="password"><br/>
                                Remember me: <input type="checkbox" name="rememberme" value="1"><br/>
            <div class="row form-group">
		<div class="col-md-12">
                    <input class="btn btn-primary btn-outline btn-lg" type="submit" name="submit" value="Login!"></div></div>
                            </form></div></div></div>
				</div>
			</div>
		</div>
...
?>
	<div id="fh5co-reservation-form" class="fh3co-section" style="margin-top:50px;">
		<div class="container">
                 
				<div class="col-md-8 fh5co-heading animate-box">

                                   
                                         <h2 style="display: flex; justify-content: center; margin-top:10px">Cine raspunde corect, poate sa faca rezervare!!</h2>
					<form id="form-wrap" method='post' action='pag2.php'>
						<div class="row form-group">
							<div class="col-md-12">
								<label for="name">Nume</label>
								<input type="text" class="form-control" id="nume" name="text">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								
                                                                <input  class="form-control" type="hidden" name="correctsum" value="<?php echo $sum; ?>">
                                                                <h1 style="display:flex;color:white"><?php echo $number1.' + '.$number2.' = '; ?></h1>
                                                        </div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<input type="submit" class="btn btn-primary btn-outline btn-lg" value=" Submit" name="submit" value="Trimite">
							</div>
