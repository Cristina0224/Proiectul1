...
include 'conection.php';
    ...
    $sql1 = "UPDATE images SET title='$title', image='$target', pret='$pret', descriere='$descriere' WHERE id = '{$_POST['id']}'";
    ...
    <div class="col-md-8 fh5co-heading animate-box">
        ...
        <div style="display: flex; justify-content: center; flex-direction: column; align-items: center; margin-top: 100px; margin-left: 100px;">
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                Titlu: <br> <input class="form-control" type="text" name="title" value="<?php echo $record['title']; ?>"><br>
                ...
                Descriere: <br> <input class="form-control" type="text" name="descriere" value="<?php echo $record['descriere']; ?>"><br>
