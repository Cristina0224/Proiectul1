...
<form method="post" action="search.php">
 ...
 <h2 style="display: flex; justify-content: center; margin-top:10px">Search</h2>
   <form name="search_form" method="post" action="search.php">
   
   <input type="text" name="search_box" value=""class="form-control"/>
    <input style="margin-top:30px;"type="submit" name="search" value="Search "class="btn btn-primary btn-outline">
